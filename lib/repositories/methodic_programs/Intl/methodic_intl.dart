...
///Функции из этого модуля не используются.
///Они предназначены для работы с методиками и переключении методик "на лету".
///Пока актуальный список локализуемых методик грузится при старте приложения.
///Надо
